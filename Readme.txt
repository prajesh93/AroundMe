...
*******************************************************************************************************************************************
**TripAdvisor changed their API policy and no longer allow to use the API keys for research or educational purpose. So the application will not work. However, you can view the source code and understand that. The code has been properly commented to make it easy for you to understand.
